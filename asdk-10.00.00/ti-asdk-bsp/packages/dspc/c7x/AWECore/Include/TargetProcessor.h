...
#elif defined(__ADSPSHARCFX__)
#include "ADI_SHARC_FX_TargetProcessor.h"
...
#elif (defined(DSPC_CORTEX_M) && defined(CORE_M55))
#include "ARM_CortexM55_TargetProcessor.h"
...
#include "TI_C7x_TargetProcessor.h"
#elif (defined(__KCC__))
#include "Kalimba_TargetProcessor.h"
...
#if !defined(BUILD64)
#if defined(_WIN64) || defined (__x86_64__) || defined(_M_X64) || defined(_M_AMD64) || defined(__arch64__) || defined(_M_ARM64) || defined(__C7000__)
#define BUILD64
#endif
