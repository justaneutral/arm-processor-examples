...
SECTIONS
{
    ...
    .asdk_avb_rx_buffer (NOLOAD) : {} > SHM_AVB_RX
    .asdk_avb_tx_buffer (NOLOAD) : {} > SHM_AVB_TX
...
MEMORY
{
    ...
    /* Used for AVB/RX Data */
    SHM_AVB_RX:       ORIGIN = SHM_AVB_DATA_RX_BASE, LENGTH = SHM_AVB_DATA_RX_SIZE

    /* Used for AVB/TX Data */
    SHM_AVB_TX:       ORIGIN = SHM_AVB_DATA_TX_BASE, LENGTH = SHM_AVB_DATA_TX_SIZE
