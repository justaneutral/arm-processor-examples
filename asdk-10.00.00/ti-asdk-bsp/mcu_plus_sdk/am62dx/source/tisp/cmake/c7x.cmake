...
set(C7x_LIBS "$ENV{CGT7X_ROOT}/lib/libc.a")

# set(CMAKE_EXE_LINKER_FLAGS    "--library=${CMAKE_LINKER} --ram_model
# --search_path=$ENV{CGT7X_ROOT}/lib")

# set(CMAKE_EXE_LINKER_FLAGS " ${_LINKER_CPU_FLAGS} -Wl,-T ${LINKER_FILE}
# -Wl,--gc-sections") set(CMAKE_C_FLAGS_DEBUG             "-Os -g" CACHE
# INTERNAL "") set(CMAKE_C_FLAGS_RELEASE           "-Os -DNDEBUG" CACHE INTERNAL
# "") set(CMAKE_CXX_FLAGS_DEBUG           "${CMAKE_C_FLAGS_DEBUG}" CACHE
# INTERNAL "") set(CMAKE_CXX_FLAGS_RELEASE         "${CMAKE_C_FLAGS_RELEASE}"
# CACHE INTERNAL "")
