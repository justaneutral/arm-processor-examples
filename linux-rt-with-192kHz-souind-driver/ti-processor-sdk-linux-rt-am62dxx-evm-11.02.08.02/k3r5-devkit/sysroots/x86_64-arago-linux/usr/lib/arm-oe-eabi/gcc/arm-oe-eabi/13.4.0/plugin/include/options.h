...
enum opt_code
{
  ...
  OPT_Wcase_enum = 538,                      /* -Wcase-enum */
  OPT_Wcast_align = 539,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 540,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 541,             /* -Wcast-function-type */
  OPT_Wcast_qual = 542,                      /* -Wcast-qual */
  OPT_Wcast_result = 543,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 544, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 545,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 546,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 547,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 548,           /* -Wcharacter-truncation */
  OPT_Wchkp = 549,                           /* -Wchkp */
  OPT_Wclass_conversion = 550,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 551,                /* -Wclass-memaccess */
  OPT_Wclobbered = 552,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 553,                /* -Wcomma-subscript */
  OPT_Wcomment = 554,                        /* -Wcomment */
  /* OPT_Wcomments = 555, */                 /* -Wcomments */
  OPT_Wcompare_reals = 556,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 557,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 558,        /* -Wconditionally-supported */
  OPT_Wconversion = 559,                     /* -Wconversion */
  OPT_Wconversion_extra = 560,               /* -Wconversion-extra */
  OPT_Wconversion_null = 561,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 562,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 563,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 564,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 565,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 566,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 567,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 568, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 569,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 570,             /* -Wdangling-reference */
  OPT_Wdate_time = 571,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 572,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 573,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 574,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 575,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 576,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 577,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 578,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 579,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 580,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 581,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 582,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 583,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 584,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 585,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 586,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 587,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 588,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 589,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 590,                /* -Wduplicated-cond */
  OPT_Weffc__ = 591,                         /* -Weffc++ */
  OPT_Wempty_body = 592,                     /* -Wempty-body */
  OPT_Wendif_labels = 593,                   /* -Wendif-labels */
  OPT_Wenum_compare = 594,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 595,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 596,              /* -Wenum-int-mismatch */
  OPT_Werror = 597,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 598, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 599,                         /* -Werror= */
  OPT_Wexceptions = 600,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 601,           /* -Wexpansion-to-defined */
  OPT_Wextra = 602,                          /* -Wextra */
  OPT_Wextra_semi = 603,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 604,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 605,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 606,                    /* -Wfloat-equal */
  /* OPT_Wformat = 607, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 608,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 609,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 610,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 611,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 612, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 613,               /* -Wformat-overflow= */
  OPT_Wformat_security = 614,                /* -Wformat-security */
  OPT_Wformat_signedness = 615,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 616, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 617,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 618,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 619,             /* -Wformat-zero-length */
  OPT_Wformat_ = 620,                        /* -Wformat= */
  OPT_Wframe_address = 621,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 622,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 623,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 624,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 625,           /* -Wfunction-elimination */
  /* OPT_Whsa = 626, */                      /* -Whsa */
  OPT_Wif_not_aligned = 627,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 628,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 629,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 630,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 631, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 632,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 633,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 634,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 635,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 636,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 637, */                   /* -Wimport */
  OPT_Winaccessible_base = 638,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 639,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 640,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 641,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 642,             /* -Winit-list-lifetime */
  OPT_Winit_self = 643,                      /* -Winit-self */
  OPT_Winline = 644,                         /* -Winline */
  OPT_Wint_conversion = 645,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 646,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 647,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 648,               /* -Winteger-division */
  OPT_Winterference_size = 649,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 650,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 651,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 652,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 653,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 654,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 655,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 656,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 657,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 658,               /* -Wjump-misses-init */
  OPT_Wl_ = 659,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 660, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 661,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 662,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 663,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 664,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 665,                     /* -Wlogical-op */
  OPT_Wlong_long = 666,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 667,              /* -Wlto-type-mismatch */
  OPT_Wmain = 668,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 669,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 670,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 671,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 672,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 673,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 674,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 675,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 676,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 677,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 678,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 679,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 680,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 681, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 682,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 683, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 684,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 685,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 686,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 687,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 688,       /* -Wmissing-template-keyword */
  OPT_Wmudflap = 689,                        /* -Wmudflap */
  OPT_Wmultichar = 690,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 691,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 692,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 693,                     /* -Wnamespaces */
  OPT_Wnarrowing = 694,                      /* -Wnarrowing */
  OPT_Wnested_externs = 695,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 696, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 697, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 698, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 699, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 700, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 701, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 702,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 703,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 704,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 705,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 706,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 707,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 708, */               /* -Wnormalized */
  OPT_Wnormalized_ = 709,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 710,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 711,                /* -Wobjc-root-class */
  OPT_Wodr = 712,                            /* -Wodr */
  OPT_Wold_style_cast = 713,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 714,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 715,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 716,            /* -Wopenacc-parallelism */
  OPT_Wopenmp_simd = 717,                    /* -Wopenmp-simd */
  OPT_Woverflow = 718,                       /* -Woverflow */
  OPT_Woverlength_strings = 719,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 720, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 721,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 722,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 723,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 724,            /* -Woverwrite-recursive */
  OPT_Wp_ = 725,                             /* -Wp, */
  OPT_Wpacked = 726,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 727,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 728,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 729,                         /* -Wpadded */
  OPT_Wparentheses = 730,                    /* -Wparentheses */
  OPT_Wpedantic = 731,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 732,                  /* -Wpedantic-cast */
  ...
  OPT_Wpoison_system_directories = 742,      /* -Wpoison-system-directories */
  OPT_Wpragmas = 743,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 744,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 745,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 746,                       /* -Wprotocol */
  OPT_Wpsabi = 747,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 748,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 749,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 750,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 751,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 752,                /* -Wredundant-decls */
  OPT_Wredundant_move = 753,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 754,                 /* -Wredundant-tags */
  OPT_Wregister = 755,                       /* -Wregister */
  OPT_Wreorder = 756,                        /* -Wreorder */
  OPT_Wrestrict = 757,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 758,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 759,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 760,           /* -Wscalar-storage-order */
  OPT_Wselector = 761,                       /* -Wselector */
  OPT_Wself_move = 762,                      /* -Wself-move */
  OPT_Wsequence_point = 763,                 /* -Wsequence-point */
  OPT_Wshadow = 764,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 765, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 766,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 767, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 768,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 769, */            /* -Wshadow=global */
  OPT_Wshadow_local = 770,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 771,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 772,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 773,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 774, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 775,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 776,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 777,                /* -Wsign-conversion */
  OPT_Wsign_promo = 778,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 779,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 780,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 781,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 782,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 783,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 784,                    /* -Wspeculative */
  OPT_Wstack_protector = 785,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 786,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 787,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 788,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 789,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 790,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 791,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 792,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 793,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 794,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 795,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 796, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 797,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 798,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 799,            /* -Wstringop-truncation */
  OPT_Wstyle = 800,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 801,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 802,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 803,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 804,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 805,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 806,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 807,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 808,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 809,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 810,               /* -Wsuggest-override */
  OPT_Wsurprising = 811,                     /* -Wsurprising */
  OPT_Wswitch = 812,                         /* -Wswitch */
  OPT_Wswitch_bool = 813,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 814,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 815,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 816,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 817,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 818,                      /* -Wsync-nand */
  OPT_Wsynth = 819,                          /* -Wsynth */
  OPT_Wsystem_headers = 820,                 /* -Wsystem-headers */
  OPT_Wtabs = 821,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 822,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 823,           /* -Wtautological-compare */
  OPT_Wtemplates = 824,                      /* -Wtemplates */
  OPT_Wterminate = 825,                      /* -Wterminate */
  OPT_Wtraditional = 826,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 827,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 828,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 829,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 830,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 831,                           /* -Wtsan */
  OPT_Wtype_limits = 832,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 833,            /* -Wundeclared-selector */
  OPT_Wundef = 834,                          /* -Wundef */
  OPT_Wundefined_do_loop = 835,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 836,                      /* -Wunderflow */
  OPT_Wunicode = 837,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 838,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 839,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 840,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 841,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 842, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 843, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 844,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 845,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 846,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 847,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 848, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 849,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 850,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 851,                /* -Wunused-function */
  OPT_Wunused_label = 852,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 853,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 854,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 855,               /* -Wunused-parameter */
  OPT_Wunused_result = 856,                  /* -Wunused-result */
  OPT_Wunused_value = 857,                   /* -Wunused-value */
  OPT_Wunused_variable = 858,                /* -Wunused-variable */
  OPT_Wuse_after_free = 859,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 860,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 861,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 862,                   /* -Wuseless-cast */
  OPT_Wvarargs = 863,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 864,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 865,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 866,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 867,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 868,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 869,            /* -Wvirtual-move-assign */
  OPT_Wvla = 870,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 871,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 872,                  /* -Wvla-parameter */
  OPT_Wvolatile = 873,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 874,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 875,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 876,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 877,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 878,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 879,                       /* -Wzerotrip */
  OPT_X = 880,                               /* -X */
  OPT_Xassembler = 881,                      /* -Xassembler */
  OPT_Xf = 882,                              /* -Xf */
  OPT_Xlinker = 883,                         /* -Xlinker */
  OPT_Xpreprocessor = 884,                   /* -Xpreprocessor */
  OPT_Z = 885,                               /* -Z */
  OPT_ansi = 886,                            /* -ansi */
  OPT_aux_info = 887,                        /* -aux-info */
  /* OPT_aux_info_ = 888, */                 /* -aux-info= */
  OPT_c = 889,                               /* -c */
  OPT_callgraph = 890,                       /* -callgraph */
  OPT_coverage = 891,                        /* -coverage */
  OPT_cpp = 892,                             /* -cpp */
  OPT_cpp_ = 893,                            /* -cpp= */
  OPT_d = 894,                               /* -d */
  OPT_debuglib_ = 895,                       /* -debuglib= */
  OPT_defaultlib_ = 896,                     /* -defaultlib= */
  OPT_defined_only = 897,                    /* -defined-only */
  OPT_demangle = 898,                        /* -demangle */
  OPT_dstartfiles = 899,                     /* -dstartfiles */
  OPT_dump_body_ = 900,                      /* -dump-body= */
  OPT_dump_level_ = 901,                     /* -dump-level= */
  OPT_dumpbase = 902,                        /* -dumpbase */
  OPT_dumpbase_ext = 903,                    /* -dumpbase-ext */
  OPT_dumpdir = 904,                         /* -dumpdir */
  OPT_dumpfullversion = 905,                 /* -dumpfullversion */
  OPT_dumpmachine = 906,                     /* -dumpmachine */
  OPT_dumpspecs = 907,                       /* -dumpspecs */
  OPT_dumpversion = 908,                     /* -dumpversion */
  OPT_e = 909,                               /* -e */
  OPT_export_dynamic = 910,                  /* -export-dynamic */
  OPT_fPIC = 911,                            /* -fPIC */
  OPT_fPIE = 912,                            /* -fPIE */
  OPT_fRTS_ = 913,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 914,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 915,                   /* -fabi-version= */
  OPT_faccess_control = 916,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 917,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 918,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 919,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 920,                  /* -falign-commons */
  OPT_falign_functions = 921,                /* -falign-functions */
  OPT_falign_functions_ = 922,               /* -falign-functions= */
  OPT_falign_jumps = 923,                    /* -falign-jumps */
  OPT_falign_jumps_ = 924,                   /* -falign-jumps= */
  OPT_falign_labels = 925,                   /* -falign-labels */
  OPT_falign_labels_ = 926,                  /* -falign-labels= */
  OPT_falign_loops = 927,                    /* -falign-loops */
  OPT_falign_loops_ = 928,                   /* -falign-loops= */
  /* OPT_faligned_new = 929, */              /* -faligned-new */
  OPT_faligned_new_ = 930,                   /* -faligned-new= */
  OPT_fall_instantiations = 931,             /* -fall-instantiations */
  OPT_fall_intrinsics = 932,                 /* -fall-intrinsics */
  OPT_fall_virtual = 933,                    /* -fall-virtual */
  OPT_fallocation_dce = 934,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 935,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 936,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 937,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 938, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 939,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 940,         /* -falt-external-templates */
  OPT_fanalyzer = 941,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 942,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 943,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 944,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 945,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 946,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 947,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 948,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 949,    /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 950,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 951,         /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 952,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 953, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 954,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 955, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 956, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 957, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 958, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 959,            /* -fasan-shadow-offset= */
  OPT_fasm = 960,                            /* -fasm */
  OPT_fassert = 961,                         /* -fassert */
  OPT_fassociative_math = 962,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 963,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 964,                   /* -fauto-inc-dec */
  OPT_fauto_init = 965,                      /* -fauto-init */
  OPT_fauto_profile = 966,                   /* -fauto-profile */
  OPT_fauto_profile_ = 967,                  /* -fauto-profile= */
  OPT_fautomatic = 968,                      /* -fautomatic */
  OPT_fbackslash = 969,                      /* -fbackslash */
  OPT_fbacktrace = 970,                      /* -fbacktrace */
  OPT_fbit_tests = 971,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 972,             /* -fblas-matmul-limit= */
  OPT_fbounds = 973,                         /* -fbounds */
  OPT_fbounds_check = 974,                   /* -fbounds-check */
  OPT_fbounds_check_ = 975,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 976,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 977,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 978, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 979, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 980, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 981,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 982,           /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 983,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 984,                        /* -fbuiltin */
  OPT_fbuiltin_ = 985,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 986,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 987,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 988,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 989,                    /* -fcall-saved- */
  OPT_fcall_used_ = 990,                     /* -fcall-used- */
  OPT_fcaller_saves = 991,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 992,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 993,                /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 994,               /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 995,       /* -fcanonical-system-headers */
  OPT_fcase = 996,                           /* -fcase */
  /* OPT_fcf_protection = 997, */            /* -fcf-protection */
  OPT_fcf_protection_ = 998,                 /* -fcf-protection= */
  OPT_fchar8_t = 999,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1000,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1001, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1002,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1003,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1004,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1005, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1006, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1007, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1008, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1009, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1010, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1011,                  /* -fcheckaction= */
  OPT_fchecking = 1012,                      /* -fchecking */
  OPT_fchecking_ = 1013,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1014,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1015,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1016,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1017,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1018,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1019,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1020,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1021,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1022,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1023,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1024,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1025,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1026,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1027,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1028,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1029,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1030,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1031,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1032, */                /* -fcilkplus */
  OPT_fcoarray_ = 1033,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1034,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1035,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1036,                        /* -fcommon */
  OPT_fcompare_debug = 1037,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1038,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1039,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1040,                  /* -fcompare-elim */
  OPT_fconcepts = 1041,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1042,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1043,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1044,                 /* -fcond-mismatch */
  /* OPT_fconserve_space = 1045, */          /* -fconserve-space */
  OPT_fconserve_stack = 1046,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1047,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1048,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1049,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1050,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1051,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1052,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1053,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1054,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1055,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1056,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1057,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1058,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1059, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1060,                     /* -fcontracts */
  OPT_fconvert_ = 1061,                      /* -fconvert= */
  OPT_fcoroutines = 1062,                    /* -fcoroutines */
  OPT_fcpp = 1063,                           /* -fcpp */
  OPT_fcpp_begin = 1064,                     /* -fcpp-begin */
  OPT_fcpp_end = 1065,                       /* -fcpp-end */
  OPT_fcprop_registers = 1066,               /* -fcprop-registers */
  OPT_fcray_pointer = 1067,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1068,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1069,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1070, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1071,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1072,              /* -fcx-limited-range */
  OPT_fd = 1073,                             /* -fd */
  OPT_fd_lines_as_code = 1074,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1075,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1076,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1077,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1078,                      /* -fdbg-cnt= */
  OPT_fdce = 1079,                           /* -fdce */
  OPT_fdebug = 1080,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1081,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1082,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1083,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1084,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1085,             /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 1086,               /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 1087,              /* -fdebug-trace-quad */
  OPT_fdebug_types_section = 1088,           /* -fdebug-types-section */
  OPT_fdebug_ = 1089,                        /* -fdebug= */
  OPT_fdec = 1090,                           /* -fdec */
  OPT_fdec_blank_format_item = 1091,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1092,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1093,           /* -fdec-format-defaults */
  OPT_fdec_include = 1094,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1095,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1096,                      /* -fdec-math */
  OPT_fdec_static = 1097,                    /* -fdec-static */
  OPT_fdec_structure = 1098,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1099,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1100, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1101,                          /* -fdef= */
  OPT_fdefault_double_8 = 1102,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1103, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1104,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1105,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1106,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1107,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1108,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1109,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1110,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1111,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1112,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1113,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1114,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1115, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1116,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1117,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1118,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1119,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1120,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1121,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1122,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1123,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1124,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1125,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1126,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1127,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1128,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1129, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1130,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1131,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1132,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1133,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1134,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1135,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1136,               /* -fdirectives-only */
  OPT_fdisable_ = 1137,                      /* -fdisable- */
  OPT_fdoc = 1138,                           /* -fdoc */
  OPT_fdoc_dir_ = 1139,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1140,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1141,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1142,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1143,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1144,                      /* -fdruntime */
  OPT_fdse = 1145,                           /* -fdse */
  OPT_fdump_ = 1146,                         /* -fdump- */
  OPT_fdump_ada_spec = 1147,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1148,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1149,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1150,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1151,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1152,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1153,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1154,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1155,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1156,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1157,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1158,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1159,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1160,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1161,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1162,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1163,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1164, */               /* -fdump-core */
  OPT_fdump_d_original = 1165,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1166,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1167,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1168,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1169,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1170,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1171,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1172,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1173,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1174, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1175,                   /* -fdump-passes */
  OPT_fdump_scos = 1176,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1177,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1178,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1179,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1180,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1181,                /* -fearly-inlining */
  OPT_felide_constructors = 1182,            /* -felide-constructors */
  OPT_felide_type = 1183,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1184, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1185,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1186,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1187,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1188,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1189,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1190,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1191,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1192,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1193,                /* -fenum-int-equiv */
  OPT_fexceptions = 1194,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1195,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1196,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1197,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1198,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1199,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1200,               /* -fextended-opaque */
  OPT_fextern_std_ = 1201,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1202,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1203,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1204,            /* -fexternal-templates */
  OPT_ff2c = 1205,                           /* -ff2c */
  OPT_ffast_math = 1206,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1207,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1208,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1209,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1210,              /* -ffinite-math-only */
  OPT_ffixed_ = 1211,                        /* -ffixed- */
  OPT_ffixed_form = 1212,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1213,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1214,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1215,                   /* -ffloat-store */
  OPT_ffloatvalue = 1216,                    /* -ffloatvalue */
  OPT_ffold_simple_inlines = 1217,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1218,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1219, */              /* -fforce-addr */
  OPT_fforward_propagate = 1220,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1221,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1222,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1223,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1224,                     /* -ffpe-trap= */
  OPT_ffree_form = 1225,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1226,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1227,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1228,                  /* -ffreestanding */
  OPT_ffriend_injection = 1229,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1230,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1231,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1232,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1233,             /* -ffunction-sections */
  OPT_fgcse = 1234,                          /* -fgcse */
  OPT_fgcse_after_reload = 1235,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1236,                      /* -fgcse-las */
  OPT_fgcse_lm = 1237,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1238,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1239,              /* -fgen-module-list= */
  OPT_fgimple = 1240,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1241,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1242,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1243,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1244,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1245,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1246,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1247,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1248,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1249,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1250,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1251,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1252,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1253,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1254,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1255,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1256,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1257,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1258,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1259,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1260,                      /* -fgraphite */
  OPT_fgraphite_identity = 1261,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1262,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1263,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1264, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1265,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1266,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1267, */                    /* -fhelp */
  /* OPT_fhelp_ = 1268, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1269,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1270,                     /* -fhonor-std */
  OPT_fhosted = 1271,                        /* -fhosted */
  OPT_fhuge_objects = 1272,                  /* -fhuge-objects */
  OPT_fident = 1273,                         /* -fident */
  OPT_fif_conversion = 1274,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1275,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1276,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1277,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1278,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1279,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1280,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1281,            /* -fimplicit-templates */
  OPT_findex = 1282,                         /* -findex */
  OPT_findirect_inlining = 1283,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1284,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1285,               /* -finit-character= */
  OPT_finit_derived = 1286,                  /* -finit-derived */
  OPT_finit_integer_ = 1287,                 /* -finit-integer= */
  OPT_finit_local_zero = 1288,               /* -finit-local-zero */
  OPT_finit_logical_ = 1289,                 /* -finit-logical= */
  OPT_finit_real_ = 1290,                    /* -finit-real= */
  OPT_finline = 1291,                        /* -finline */
  OPT_finline_arg_packing = 1292,            /* -finline-arg-packing */
  OPT_finline_atomics = 1293,                /* -finline-atomics */
  OPT_finline_functions = 1294,              /* -finline-functions */
  OPT_finline_functions_called_once = 1295,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1296, */           /* -finline-limit- */
  OPT_finline_limit_ = 1297,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1298,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1299,        /* -finline-small-functions */
  OPT_finput_charset_ = 1300,                /* -finput-charset= */
  OPT_finstrument_functions = 1301,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1302,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1303,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1304,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1305,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1306,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1307,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1308,                    /* -finvariants */
  OPT_fipa_bit_cp = 1309,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1310,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1311, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1312,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1313,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1314,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1315,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1316, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1317,                    /* -fipa-modref */
  OPT_fipa_profile = 1318,                   /* -fipa-profile */
  OPT_fipa_pta = 1319,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1320,                /* -fipa-pure-const */
  OPT_fipa_ra = 1321,                        /* -fipa-ra */
  OPT_fipa_reference = 1322,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1323,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1324,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1325,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1326,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1327, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1328,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1329,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1330,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1331,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1332,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1333,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1334,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1335,                  /* -fira-verbose= */
  OPT_fiso = 1336,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1337,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1338,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1339,              /* -fivar-visibility= */
  OPT_fivopts = 1340,                        /* -fivopts */
  OPT_fjump_tables = 1341,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1342,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1343,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1344,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1345,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1346,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1347,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1348,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1349,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1350,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1351,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1352,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1353,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1354,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1355,            /* -fleading-underscore */
  OPT_flibs_ = 1356,                         /* -flibs= */
  OPT_flifetime_dse = 1357,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1358,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1359,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1360,                /* -flinker-output= */
  /* OPT_flive_patching = 1361, */           /* -flive-patching */
  OPT_flive_patching_ = 1362,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1363,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1364,                   /* -flocal-ivars */
  OPT_flocation_ = 1365,                     /* -flocation= */
  /* OPT_floop_block = 1366, */              /* -floop-block */
  /* OPT_floop_flatten = 1367, */            /* -floop-flatten */
  OPT_floop_interchange = 1368,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1369,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1370, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1371,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1372, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1373,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1374,                     /* -flra-remat */
  OPT_flto = 1375,                           /* -flto */
  OPT_flto_compression_level_ = 1376,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1377, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1378,                /* -flto-partition= */
  OPT_flto_report = 1379,                    /* -flto-report */
  OPT_flto_report_wpa = 1380,                /* -flto-report-wpa */
  OPT_flto_ = 1381,                          /* -flto= */
  OPT_fltrans = 1382,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1383,           /* -fltrans-output-list= */
  OPT_fm2_g = 1384,                          /* -fm2-g */
  OPT_fm2_lower_case = 1385,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1386,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1387,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1388,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1389,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1390,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1391,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1392,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1393,             /* -fmacro-prefix-map= */
  OPT_fmain = 1394,                          /* -fmain */
  OPT_fmath_errno = 1395,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1396,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1397,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1398,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1399,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1400,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1401,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1402,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1403,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1404,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1405,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1406,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1407,               /* -fmessage-length= */
  OPT_fmod_ = 1408,                          /* -fmod= */
  OPT_fmodule_file_ = 1409,                  /* -fmodule-file= */
  OPT_fmodule_header = 1410,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1411,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1412,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1413,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1414,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1415,                   /* -fmodule-only */
  OPT_fmodule_private = 1416,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1417,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1418,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1419,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1420,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1421,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1422,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1423,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1424,                 /* -fms-extensions */
  OPT_fmudflap = 1425,                       /* -fmudflap */
  OPT_fmudflapir = 1426,                     /* -fmudflapir */
  OPT_fmudflapth = 1427,                     /* -fmudflapth */
  OPT_fmultiflags = 1428,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1429,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1430,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1431,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1432,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1433,                  /* -fnext-runtime */
  OPT_fnil = 1434,                           /* -fnil */
  OPT_fnil_receivers = 1435,                 /* -fnil-receivers */
  OPT_fno_modules = 1436,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1437,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1438,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1439,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1440,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1441,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1442,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1443,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1444,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1445,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1446,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1447,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1448,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1449,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1450,              /* -foffload-options= */
  OPT_foffload_ = 1451,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1452,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1453,                         /* -fonly= */
  OPT_fopenacc = 1454,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1455,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1456,                        /* -fopenmp */
  OPT_fopenmp_simd = 1457,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1458, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1459,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1460,                /* -foperator-names */
  OPT_fopt_info = 1461,                      /* -fopt-info */
  OPT_fopt_info_ = 1462,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1463, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1464,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1465,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1466, */          /* -foptional-diags */
  OPT_fpack_derived = 1467,                  /* -fpack-derived */
  OPT_fpack_struct = 1468,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1469,                  /* -fpack-struct= */
  OPT_fpad_source = 1470,                    /* -fpad-source */
  OPT_fpartial_inlining = 1471,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1472,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1473,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1474,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1475,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1476,                    /* -fpeel-loops */
  OPT_fpeephole = 1477,                      /* -fpeephole */
  OPT_fpeephole2 = 1478,                     /* -fpeephole2 */
  OPT_fpermissive = 1479,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1480,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1481,                           /* -fpic */
  OPT_fpie = 1482,                           /* -fpie */
  OPT_fpim = 1483,                           /* -fpim */
  OPT_fpim2 = 1484,                          /* -fpim2 */
  OPT_fpim3 = 1485,                          /* -fpim3 */
  OPT_fpim4 = 1486,                          /* -fpim4 */
  OPT_fplan9_extensions = 1487,              /* -fplan9-extensions */
  OPT_fplt = 1488,                           /* -fplt */
  OPT_fplugin_arg_ = 1489,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1490,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1491,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1492,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1493,                /* -fpostconditions */
  OPT_fpre_include_ = 1494,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1495,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1496,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1497,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1498,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1499,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1500,              /* -fpretty-templates */
  OPT_fpreview_all = 1501,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1502,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1503,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1504,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1505,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1506,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1507,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1508,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1509,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1510,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1511,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1512,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1513,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1514,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1515,           /* -fprintf-return-value */
  OPT_fprofile = 1516,                       /* -fprofile */
  OPT_fprofile_abs_path = 1517,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1518,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1519,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1520,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1521,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1522,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1523,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1524,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1525,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1526,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1527,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1528,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1529,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1530,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1531,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1532,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1533,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1534,               /* -fprofile-update= */
  OPT_fprofile_use = 1535,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1536,                  /* -fprofile-use= */
  OPT_fprofile_values = 1537,                /* -fprofile-values */
  OPT_fprotect_parens = 1538,                /* -fprotect-parens */
  OPT_fpthread = 1539,                       /* -fpthread */
  OPT_fq = 1540,                             /* -fq */
  OPT_frandom_seed = 1541,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1542,                  /* -frandom-seed= */
  OPT_frange = 1543,                         /* -frange */
  OPT_frange_check = 1544,                   /* -frange-check */
  OPT_freal_4_real_10 = 1545,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1546,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1547,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1548,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1549,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1550,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1551,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1552,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1553,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1554,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1555,               /* -frecord-marker=8 */
  OPT_frecursive = 1556,                     /* -frecursive */
  OPT_free = 1557,                           /* -free */
  OPT_freg_struct_return = 1558,             /* -freg-struct-return */
  /* OPT_fregmove = 1559, */                 /* -fregmove */
  OPT_frelease = 1560,                       /* -frelease */
  OPT_frename_registers = 1561,              /* -frename-registers */
  OPT_freorder_blocks = 1562,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1563,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1564,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1565,             /* -freorder-functions */
  OPT_frepack_arrays = 1566,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1567,          /* -freplace-objc-classes */
  OPT_frepo = 1568,                          /* -frepo */
  OPT_freport_bug = 1569,                    /* -freport-bug */
  OPT_frequire_return_statement = 1570,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1571,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1572, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1573,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1574,                   /* -fresolution= */
  OPT_freturn = 1575,                        /* -freturn */
  OPT_frevert_all = 1576,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1577,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1578,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1579,             /* -frevert=intpromote */
  OPT_frounding_math = 1580,                 /* -frounding-math */
  OPT_frtti = 1581,                          /* -frtti */
  OPT_fruntime_modules_ = 1582,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1583,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1584,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1585,                   /* -frust-crate= */
  OPT_frust_debug = 1586,                    /* -frust-debug */
  OPT_frust_dump_ = 1587,                    /* -frust-dump- */
  OPT_frust_edition_ = 1588,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1589,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1590,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1591,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1592,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1593,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1594,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1595,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1596,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1597,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1598,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1599,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1600,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1601, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1602,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1603,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1604,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1605,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1606,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1607,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1608,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1609,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1610, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1611,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1612,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1613,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1614,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1615,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1616,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1617,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1618,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1619,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1620,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1621,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1622,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1623,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1624,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1625,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1626,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1627, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1628,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1629,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1630,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1631,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1632,               /* -fsection-anchors */
  /* OPT_fsee = 1633, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1634,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1635,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1636,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1637,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1638,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1639,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1640,        /* -fsemantic-interposition */
  OPT_fshared = 1641,                        /* -fshared */
  OPT_fshort_enums = 1642,                   /* -fshort-enums */
  OPT_fshort_wchar = 1643,                   /* -fshort-wchar */
  OPT_fshow_column = 1644,                   /* -fshow-column */
  OPT_fshrink_wrap = 1645,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1646,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1647,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1648,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1649,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1650,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1651,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1652,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1653,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1654,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1655,                /* -fsoft-check-all */
  OPT_fsources = 1656,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1657,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1658,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1659,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1660,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1661,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1662,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1663,                      /* -fsquangle */
  OPT_fssa_backprop = 1664,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1665,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1666,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1667,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1668, */             /* -fstack-check */
  OPT_fstack_check_ = 1669,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1670,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1671,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1672,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1673,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1674,               /* -fstack-protector */
  OPT_fstack_protector_all = 1675,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1676,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1677,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1678,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1679,                   /* -fstack-usage */
  OPT_fstats = 1680,                         /* -fstats */
  OPT_fstdarg_opt = 1681,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1682,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1683, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1684,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1685,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1686, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1687,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1688,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1689,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1690,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1691, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1692,            /* -fstrong-eval-order= */
  OPT_fswig = 1693,                          /* -fswig */
  OPT_fswitch_errors = 1694,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1695,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1696,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1697,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1698, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1699,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1700, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1701,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1702, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1703,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1704,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1705,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1706,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1707,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1708,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1709,                   /* -ftime-report */
  OPT_ftime_report_details = 1710,           /* -ftime-report-details */
  OPT_ftls_model_ = 1711,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1712,              /* -ftoplevel-reorder */
  OPT_ftracer = 1713,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1714,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1715,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1716,                   /* -ftrampolines */
  OPT_ftransition_all = 1717,                /* -ftransition=all */
  OPT_ftransition_field = 1718,              /* -ftransition=field */
  OPT_ftransition_in = 1719,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1720,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1721,          /* -ftransition=templates */
  OPT_ftransition_tls = 1722,                /* -ftransition=tls */
  OPT_ftrapping_math = 1723,                 /* -ftrapping-math */
  OPT_ftrapv = 1724,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1725,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1726,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1727,                      /* -ftree-ccp */
  OPT_ftree_ch = 1728,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1729, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1730,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1731,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1732, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1733,                   /* -ftree-cselim */
  OPT_ftree_dce = 1734,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1735,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1736,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1737,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1738,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1739, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1740,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1741,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1742, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1743,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1744,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1745, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1746,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1747,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1748,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1749,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1750,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1751,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1752,                      /* -ftree-pre */
  OPT_ftree_pta = 1753,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1754,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1755, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1756,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1757,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1758,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1759,                     /* -ftree-slsr */
  OPT_ftree_sra = 1760,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1761, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1762, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1763,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1764,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1765,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1766, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1767,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1768, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1769,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1770,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1771,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1772,         /* -funconstrained-commons */
  OPT_funderscoring = 1773,                  /* -funderscoring */
  OPT_funit_at_a_time = 1774,                /* -funit-at-a-time */
  OPT_funittest = 1775,                      /* -funittest */
  OPT_funreachable_traps = 1776,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1777,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1778,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1779,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1780, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1781,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1782,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1783,                 /* -funsigned-char */
  OPT_funswitch_loops = 1784,                /* -funswitch-loops */
  OPT_funwind_tables = 1785,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1786,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1787,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1788,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1789,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1790,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1791,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1792,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1793,                     /* -fuse-list= */
  OPT_fvar_tracking = 1794,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1795,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1796,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1797,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1798,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1799, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1800,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1801,                   /* -fverbose-asm */
  /* OPT_fversion = 1802, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1803,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1804,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1805,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1806,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1807,                   /* -fvisibility= */
  OPT_fvpt = 1808,                           /* -fvpt */
  OPT_fvtable_gc = 1809,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1810,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1811,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1812,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1813,                     /* -fvtv-debug */
  OPT_fweak = 1814,                          /* -fweak */
  OPT_fweak_templates = 1815,                /* -fweak-templates */
  OPT_fweb = 1816,                           /* -fweb */
  /* OPT_fwhole_file = 1817, */              /* -fwhole-file */
  OPT_fwhole_program = 1818,                 /* -fwhole-program */
  OPT_fwholediv = 1819,                      /* -fwholediv */
  OPT_fwholevalue = 1820,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1821,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1822,             /* -fworking-directory */
  OPT_fwpa = 1823,                           /* -fwpa */
  OPT_fwpa_ = 1824,                          /* -fwpa= */
  OPT_fwrapv = 1825,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1826,                 /* -fwrapv-pointer */
  OPT_fxref = 1827,                          /* -fxref */
  /* OPT_fzee = 1828, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1829,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1830,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1831,                     /* -fzero-link */
  OPT_g = 1832,                              /* -g */
  OPT_gant = 1833,                           /* -gant */
  OPT_gas_loc_support = 1834,                /* -gas-loc-support */
  OPT_gas_locview_support = 1835,            /* -gas-locview-support */
  OPT_gbtf = 1836,                           /* -gbtf */
  ...
  OPT_list = 1890,                           /* -list */
  OPT_mabi_ = 1891,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1892,             /* -mabort-on-noreturn */
  OPT_mapcs = 1893,                          /* -mapcs */
  OPT_mapcs_frame = 1894,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1895,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1896,              /* -mapcs-stack-check */
  OPT_march_ = 1897,                         /* -march= */
  OPT_marm = 1898,                           /* -marm */
  OPT_masm_syntax_unified = 1899,            /* -masm-syntax-unified */
  OPT_mbe32 = 1900,                          /* -mbe32 */
  OPT_mbe8 = 1901,                           /* -mbe8 */
  OPT_mbig_endian = 1902,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1903,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 1904,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 1905,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1906,     /* -mcaller-super-interworking */
  OPT_mcmse = 1907,                          /* -mcmse */
  OPT_mcpu_ = 1908,                          /* -mcpu= */
  OPT_mfdpic = 1909,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1910,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1911,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1912, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1913,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1914,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1915,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1916,                  /* -mfp16-format= */
  OPT_mfpu_ = 1917,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1918,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1919, */              /* -mhard-float */
  OPT_mlibarch_ = 1920,                      /* -mlibarch= */
  OPT_mlittle_endian = 1921,                 /* -mlittle-endian */
  OPT_mlong_calls = 1922,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1923,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1924,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1925,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1926,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1927,               /* -mprint-tune-info */
  OPT_mpure_code = 1928,                     /* -mpure-code */
  OPT_mrestrict_it = 1929,                   /* -mrestrict-it */
  OPT_msched_prolog = 1930,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1931,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1932,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1933, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 1934, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 1935,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 1936,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1937,                         /* -mthumb */
  OPT_mthumb_interwork = 1938,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1939,                  /* -mtls-dialect= */
  OPT_mtp_ = 1940,                           /* -mtp= */
  OPT_mtpcs_frame = 1941,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1942,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1943,                         /* -mtune= */
  OPT_munaligned_access = 1944,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1945,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1946,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1947,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1948,              /* -mword-relocations */
  OPT_n = 1949,                              /* -n */
  OPT_name_sort = 1950,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1951,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1952,              /* -no-integrated-cpp */
  OPT_no_pie = 1953,                         /* -no-pie */
  OPT_nocpp = 1954,                          /* -nocpp */
  OPT_nodefaultlibs = 1955,                  /* -nodefaultlibs */
  OPT_nolibc = 1956,                         /* -nolibc */
  OPT_nophoboslib = 1957,                    /* -nophoboslib */
  OPT_nostartfiles = 1958,                   /* -nostartfiles */
  OPT_nostdinc = 1959,                       /* -nostdinc */
  OPT_nostdinc__ = 1960,                     /* -nostdinc++ */
  OPT_nostdlib = 1961,                       /* -nostdlib */
  OPT_nostdlib__ = 1962,                     /* -nostdlib++ */
  OPT_o = 1963,                              /* -o */
  OPT_objects = 1964,                        /* -objects */
  OPT_p = 1965,                              /* -p */
  OPT_pass_exit_codes = 1966,                /* -pass-exit-codes */
  /* OPT_pedantic = 1967, */                 /* -pedantic */
  OPT_pedantic_errors = 1968,                /* -pedantic-errors */
  OPT_pg = 1969,                             /* -pg */
  OPT_pie = 1970,                            /* -pie */
  OPT_pipe = 1971,                           /* -pipe */
  OPT_print_file_name_ = 1972,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1973,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1974,          /* -print-multi-directory */
  OPT_print_multi_lib = 1975,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1976,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1977,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1978,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1979,               /* -print-prog-name= */
  OPT_print_search_dirs = 1980,              /* -print-search-dirs */
  OPT_print_sysroot = 1981,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1982,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1983,                    /* -print-value */
  OPT_quiet = 1984,                          /* -quiet */
  OPT_r = 1985,                              /* -r */
  OPT_remap = 1986,                          /* -remap */
  OPT_reverse_sort = 1987,                   /* -reverse-sort */
  OPT_s = 1988,                              /* -s */
  OPT_save_temps = 1989,                     /* -save-temps */
  OPT_save_temps_ = 1990,                    /* -save-temps= */
  OPT_shared = 1991,                         /* -shared */
  OPT_shared_libgcc = 1992,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1993,               /* -shared-libphobos */
  OPT_size_sort = 1994,                      /* -size-sort */
  /* OPT_specs = 1995, */                    /* -specs */
  OPT_specs_ = 1996,                         /* -specs= */
  OPT_static = 1997,                         /* -static */
  OPT_static_libasan = 1998,                 /* -static-libasan */
  OPT_static_libgcc = 1999,                  /* -static-libgcc */
  OPT_static_libgfortran = 2000,             /* -static-libgfortran */
  OPT_static_libgm2 = 2001,                  /* -static-libgm2 */
  OPT_static_libgo = 2002,                   /* -static-libgo */
  OPT_static_libhwasan = 2003,               /* -static-libhwasan */
  OPT_static_liblsan = 2004,                 /* -static-liblsan */
  OPT_static_libmpx = 2005,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2006,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2007,               /* -static-libphobos */
  OPT_static_libquadmath = 2008,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2009,               /* -static-libstdc++ */
  OPT_static_libtsan = 2010,                 /* -static-libtsan */
  OPT_static_libubsan = 2011,                /* -static-libubsan */
  OPT_static_pie = 2012,                     /* -static-pie */
  /* OPT_std_c__03 = 2013, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2014, */                /* -std=c++0x */
  OPT_std_c__11 = 2015,                      /* -std=c++11 */
  OPT_std_c__14 = 2016,                      /* -std=c++14 */
  OPT_std_c__17 = 2017,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2018, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2019, */                /* -std=c++1z */
  OPT_std_c__20 = 2020,                      /* -std=c++20 */
  OPT_std_c__23 = 2021,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2022, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2023, */                /* -std=c++2b */
  OPT_std_c__98 = 2024,                      /* -std=c++98 */
  OPT_std_c11 = 2025,                        /* -std=c11 */
  OPT_std_c17 = 2026,                        /* -std=c17 */
  /* OPT_std_c18 = 2027, */                  /* -std=c18 */
  /* OPT_std_c1x = 2028, */                  /* -std=c1x */
  OPT_std_c2x = 2029,                        /* -std=c2x */
  /* OPT_std_c89 = 2030, */                  /* -std=c89 */
  OPT_std_c90 = 2031,                        /* -std=c90 */
  OPT_std_c99 = 2032,                        /* -std=c99 */
  /* OPT_std_c9x = 2033, */                  /* -std=c9x */
  OPT_std_f2003 = 2034,                      /* -std=f2003 */
  OPT_std_f2008 = 2035,                      /* -std=f2008 */
  OPT_std_f2008ts = 2036,                    /* -std=f2008ts */
  OPT_std_f2018 = 2037,                      /* -std=f2018 */
  OPT_std_f95 = 2038,                        /* -std=f95 */
  OPT_std_gnu = 2039,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2040, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2041, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2042,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2043,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2044,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2045, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2046, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2047,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2048,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2049, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2050, */              /* -std=gnu++2b */
