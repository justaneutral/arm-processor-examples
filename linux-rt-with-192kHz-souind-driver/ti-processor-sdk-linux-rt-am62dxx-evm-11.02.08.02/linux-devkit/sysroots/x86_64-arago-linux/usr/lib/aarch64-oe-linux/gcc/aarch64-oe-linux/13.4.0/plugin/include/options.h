...
enum opt_code
{
  ...
  OPT__param_uninit_max_chain_len_ = 334,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 335,   /* --param=uninit-max-num-chains= */
  ...
  /* OPT__pass_exit_codes = 353, */          /* --pass-exit-codes */
  /* OPT__pedantic = 354, */                 /* --pedantic */
  /* OPT__pedantic_errors = 355, */          /* --pedantic-errors */
  /* OPT__pie = 356, */                      /* --pie */
  /* OPT__pipe = 357, */                     /* --pipe */
  /* OPT__prefix = 358, */                   /* --prefix */
  /* OPT__prefix_ = 359, */                  /* --prefix= */
  /* OPT__preprocess = 360, */               /* --preprocess */
  /* OPT__print_file_name = 361, */          /* --print-file-name */
  /* OPT__print_file_name_ = 362, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 363, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 364, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 365, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 366, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 367, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 368, */          /* --print-multiarch */
  /* OPT__print_prog_name = 369, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 370, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 371, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 372, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 373, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 374, */                  /* --profile */
  /* OPT__save_temps = 375, */               /* --save-temps */
  /* OPT__shared = 376, */                   /* --shared */
  /* OPT__specs = 377, */                    /* --specs */
  /* OPT__specs_ = 378, */                   /* --specs= */
  /* OPT__static = 379, */                   /* --static */
  /* OPT__static_pie = 380, */               /* --static-pie */
  /* OPT__symbolic = 381, */                 /* --symbolic */
  /* OPT__sysroot = 382, */                  /* --sysroot */
  OPT__sysroot_ = 383,                       /* --sysroot= */
  OPT__target_help = 384,                    /* --target-help */
  /* OPT__time = 385, */                     /* --time */
  /* OPT__trace_includes = 386, */           /* --trace-includes */
  /* OPT__traditional = 387, */              /* --traditional */
  /* OPT__traditional_cpp = 388, */          /* --traditional-cpp */
  /* OPT__trigraphs = 389, */                /* --trigraphs */
  /* OPT__undefine_macro = 390, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 391, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 392, */        /* --user-dependencies */
  /* OPT__verbose = 393, */                  /* --verbose */
  OPT__version = 394,                        /* --version */
  /* OPT__write_dependencies = 395, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 396, */  /* --write-user-dependencies */
  OPT_A = 397,                               /* -A */
  OPT_B = 398,                               /* -B */
  OPT_C = 399,                               /* -C */
  OPT_CC = 400,                              /* -CC */
  ...
  OPT_MQ = 417,                              /* -MQ */
  OPT_MT = 418,                              /* -MT */
  OPT_Mmodules = 419,                        /* -Mmodules */
  OPT_Mno_modules = 420,                     /* -Mno-modules */
  OPT_N = 421,                               /* -N */
  OPT_O = 422,                               /* -O */
  OPT_Ofast = 423,                           /* -Ofast */
  OPT_Og = 424,                              /* -Og */
  ...
  OPT_Tbss_ = 435,                           /* -Tbss= */
  OPT_Tdata = 436,                           /* -Tdata */
  OPT_Tdata_ = 437,                          /* -Tdata= */
  OPT_Ttext = 438,                           /* -Ttext */
  OPT_Ttext_ = 439,                          /* -Ttext= */
  OPT_U = 440,                               /* -U */
  /* OPT_W = 441, */                         /* -W */
  OPT_WNSObject_attribute = 442,             /* -WNSObject-attribute */
  OPT_Wa_ = 443,                             /* -Wa, */
  OPT_Wabi = 444,                            /* -Wabi */
  OPT_Wabi_tag = 445,                        /* -Wabi-tag */
  OPT_Wabi_ = 446,                           /* -Wabi= */
  OPT_Wabsolute_value = 447,                 /* -Wabsolute-value */
  OPT_Waddress = 448,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 449,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 450,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 451,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 452,                       /* -Waliasing */
  OPT_Walign_commons = 453,                  /* -Walign-commons */
  /* OPT_Waligned_new = 454, */              /* -Waligned-new */
  OPT_Waligned_new_ = 455,                   /* -Waligned-new= */
  OPT_Wall = 456,                            /* -Wall */
  ...
  OPT_Wanalyzer_infinite_recursion = 478,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 479,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 480,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 481,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 482,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 483,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 484,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_possible_null_argument = 485,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 486,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 487,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 488,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 489,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 490,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_allocation_size = 491,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 492,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 493,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 494,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 495,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 496,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 497,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 498,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 499,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 500,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 501,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 502,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 503,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 504,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 505,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 506,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 507,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 508,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 509,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 510, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 511,                  /* -Warray-bounds= */
  OPT_Warray_compare = 512,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 513, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 514,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 515,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 516,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 517, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 518,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 519,              /* -Wattribute-warning */
  OPT_Wattributes = 520,                     /* -Wattributes */
  OPT_Wattributes_ = 521,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 522,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 523, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 524,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 525,                   /* -Wbool-compare */
  OPT_Wbool_operation = 526,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 527,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 528,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 529,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 530, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 531,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 532,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 533,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 534,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 535,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 536,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 537, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 538,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 539,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 540,               /* -Wc++23-extensions */
  /* OPT_Wc__2a_compat = 541, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 542,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 543,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 544,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 545,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 546,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 547,                      /* -Wcase-enum */
  OPT_Wcast_align = 548,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 549,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 550,             /* -Wcast-function-type */
  OPT_Wcast_qual = 551,                      /* -Wcast-qual */
  OPT_Wcast_result = 552,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 553, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 554,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 555,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 556,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 557,           /* -Wcharacter-truncation */
  OPT_Wchkp = 558,                           /* -Wchkp */
  OPT_Wclass_conversion = 559,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 560,                /* -Wclass-memaccess */
  OPT_Wclobbered = 561,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 562,                /* -Wcomma-subscript */
  OPT_Wcomment = 563,                        /* -Wcomment */
  /* OPT_Wcomments = 564, */                 /* -Wcomments */
  OPT_Wcompare_reals = 565,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 566,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 567,        /* -Wconditionally-supported */
  OPT_Wconversion = 568,                     /* -Wconversion */
  OPT_Wconversion_extra = 569,               /* -Wconversion-extra */
  OPT_Wconversion_null = 570,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 571,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 572,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 573,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 574,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 575,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 576,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 577, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 578,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 579,             /* -Wdangling-reference */
  OPT_Wdate_time = 580,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 581,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 582,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 583,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 584,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 585,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 586,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 587,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 588,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 589,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 590,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 591,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 592,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 593,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 594,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 595,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 596,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 597,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 598,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 599,                /* -Wduplicated-cond */
  OPT_Weffc__ = 600,                         /* -Weffc++ */
  OPT_Wempty_body = 601,                     /* -Wempty-body */
  OPT_Wendif_labels = 602,                   /* -Wendif-labels */
  OPT_Wenum_compare = 603,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 604,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 605,              /* -Wenum-int-mismatch */
  OPT_Werror = 606,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 607, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 608,                         /* -Werror= */
  OPT_Wexceptions = 609,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 610,           /* -Wexpansion-to-defined */
  OPT_Wextra = 611,                          /* -Wextra */
  OPT_Wextra_semi = 612,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 613,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 614,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 615,                    /* -Wfloat-equal */
  /* OPT_Wformat = 616, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 617,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 618,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 619,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 620,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 621, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 622,               /* -Wformat-overflow= */
  OPT_Wformat_security = 623,                /* -Wformat-security */
  OPT_Wformat_signedness = 624,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 625, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 626,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 627,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 628,             /* -Wformat-zero-length */
  OPT_Wformat_ = 629,                        /* -Wformat= */
  OPT_Wframe_address = 630,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 631,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 632,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 633,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 634,           /* -Wfunction-elimination */
  /* OPT_Whsa = 635, */                      /* -Whsa */
  OPT_Wif_not_aligned = 636,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 637,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 638,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 639,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 640, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 641,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 642,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 643,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 644,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 645,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 646, */                   /* -Wimport */
  OPT_Winaccessible_base = 647,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 648,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 649,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 650,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 651,             /* -Winit-list-lifetime */
  OPT_Winit_self = 652,                      /* -Winit-self */
  OPT_Winline = 653,                         /* -Winline */
  OPT_Wint_conversion = 654,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 655,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 656,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 657,               /* -Winteger-division */
  OPT_Winterference_size = 658,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 659,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 660,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 661,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 662,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 663,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 664,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 665,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 666,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 667,               /* -Wjump-misses-init */
  OPT_Wl_ = 668,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 669, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 670,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 671,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 672,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 673,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 674,                     /* -Wlogical-op */
  OPT_Wlong_long = 675,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 676,              /* -Wlto-type-mismatch */
  OPT_Wmain = 677,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 678,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 679,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 680,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 681,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 682,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 683,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 684,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 685,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 686,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 687,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 688,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 689,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 690, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 691,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 692, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 693,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 694,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 695,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 696,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 697,       /* -Wmissing-template-keyword */
  OPT_Wmudflap = 698,                        /* -Wmudflap */
  OPT_Wmultichar = 699,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 700,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 701,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 702,                     /* -Wnamespaces */
  OPT_Wnarrowing = 703,                      /* -Wnarrowing */
  OPT_Wnested_externs = 704,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 705, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 706, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 707, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 708, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 709, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 710, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 711,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 712,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 713,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 714,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 715,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 716,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 717, */               /* -Wnormalized */
  OPT_Wnormalized_ = 718,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 719,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 720,                /* -Wobjc-root-class */
  OPT_Wodr = 721,                            /* -Wodr */
  OPT_Wold_style_cast = 722,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 723,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 724,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 725,            /* -Wopenacc-parallelism */
  OPT_Wopenmp_simd = 726,                    /* -Wopenmp-simd */
  OPT_Woverflow = 727,                       /* -Woverflow */
  OPT_Woverlength_strings = 728,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 729, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 730,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 731,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 732,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 733,            /* -Woverwrite-recursive */
  OPT_Wp_ = 734,                             /* -Wp, */
  OPT_Wpacked = 735,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 736,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 737,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 738,                         /* -Wpadded */
  OPT_Wparentheses = 739,                    /* -Wparentheses */
  OPT_Wpedantic = 740,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 741,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 742,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 743,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 744, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 745,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 746,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 747,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 748,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 749,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 750,            /* -Wpointer-to-int-cast */
  OPT_Wpoison_system_directories = 751,      /* -Wpoison-system-directories */
  OPT_Wpragmas = 752,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 753,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 754,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 755,                       /* -Wprotocol */
  OPT_Wpsabi = 756,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 757,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 758,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 759,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 760,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 761,                /* -Wredundant-decls */
  OPT_Wredundant_move = 762,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 763,                 /* -Wredundant-tags */
  OPT_Wregister = 764,                       /* -Wregister */
  OPT_Wreorder = 765,                        /* -Wreorder */
  OPT_Wrestrict = 766,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 767,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 768,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 769,           /* -Wscalar-storage-order */
  OPT_Wselector = 770,                       /* -Wselector */
  OPT_Wself_move = 771,                      /* -Wself-move */
  OPT_Wsequence_point = 772,                 /* -Wsequence-point */
  OPT_Wshadow = 773,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 774, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 775,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 776, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 777,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 778, */            /* -Wshadow=global */
  OPT_Wshadow_local = 779,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 780,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 781,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 782,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 783, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 784,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 785,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 786,                /* -Wsign-conversion */
  OPT_Wsign_promo = 787,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 788,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 789,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 790,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 791,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 792,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 793,                    /* -Wspeculative */
  OPT_Wstack_protector = 794,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 795,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 796,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 797,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 798,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 799,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 800,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 801,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 802,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 803,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 804,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 805, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 806,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 807,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 808,            /* -Wstringop-truncation */
  OPT_Wstyle = 809,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 810,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 811,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 812,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 813,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 814,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 815,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 816,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 817,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 818,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 819,               /* -Wsuggest-override */
  OPT_Wsurprising = 820,                     /* -Wsurprising */
  OPT_Wswitch = 821,                         /* -Wswitch */
  OPT_Wswitch_bool = 822,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 823,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 824,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 825,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 826,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 827,                      /* -Wsync-nand */
  OPT_Wsynth = 828,                          /* -Wsynth */
  OPT_Wsystem_headers = 829,                 /* -Wsystem-headers */
  OPT_Wtabs = 830,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 831,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 832,           /* -Wtautological-compare */
  OPT_Wtemplates = 833,                      /* -Wtemplates */
  OPT_Wterminate = 834,                      /* -Wterminate */
  OPT_Wtraditional = 835,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 836,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 837,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 838,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 839,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 840,                           /* -Wtsan */
  OPT_Wtype_limits = 841,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 842,            /* -Wundeclared-selector */
  OPT_Wundef = 843,                          /* -Wundef */
  OPT_Wundefined_do_loop = 844,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 845,                      /* -Wunderflow */
  OPT_Wunicode = 846,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 847,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 848,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 849,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 850,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 851, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 852, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 853,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 854,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 855,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 856,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 857, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 858,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 859,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 860,                /* -Wunused-function */
  OPT_Wunused_label = 861,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 862,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 863,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 864,               /* -Wunused-parameter */
  OPT_Wunused_result = 865,                  /* -Wunused-result */
  OPT_Wunused_value = 866,                   /* -Wunused-value */
  OPT_Wunused_variable = 867,                /* -Wunused-variable */
  OPT_Wuse_after_free = 868,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 869,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 870,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 871,                   /* -Wuseless-cast */
  OPT_Wvarargs = 872,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 873,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 874,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 875,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 876,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 877,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 878,            /* -Wvirtual-move-assign */
  OPT_Wvla = 879,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 880,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 881,                  /* -Wvla-parameter */
  OPT_Wvolatile = 882,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 883,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 884,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 885,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 886,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 887,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 888,                       /* -Wzerotrip */
  OPT_X = 889,                               /* -X */
  OPT_Xassembler = 890,                      /* -Xassembler */
  OPT_Xf = 891,                              /* -Xf */
  OPT_Xlinker = 892,                         /* -Xlinker */
  OPT_Xpreprocessor = 893,                   /* -Xpreprocessor */
  OPT_Z = 894,                               /* -Z */
  OPT_ansi = 895,                            /* -ansi */
  OPT_aux_info = 896,                        /* -aux-info */
  /* OPT_aux_info_ = 897, */                 /* -aux-info= */
  OPT_c = 898,                               /* -c */
  OPT_callgraph = 899,                       /* -callgraph */
  OPT_coverage = 900,                        /* -coverage */
  OPT_cpp = 901,                             /* -cpp */
  OPT_cpp_ = 902,                            /* -cpp= */
  OPT_d = 903,                               /* -d */
  OPT_debuglib_ = 904,                       /* -debuglib= */
  OPT_defaultlib_ = 905,                     /* -defaultlib= */
  OPT_defined_only = 906,                    /* -defined-only */
  OPT_demangle = 907,                        /* -demangle */
  OPT_dstartfiles = 908,                     /* -dstartfiles */
  OPT_dump_body_ = 909,                      /* -dump-body= */
  OPT_dump_level_ = 910,                     /* -dump-level= */
  OPT_dumpbase = 911,                        /* -dumpbase */
  OPT_dumpbase_ext = 912,                    /* -dumpbase-ext */
  OPT_dumpdir = 913,                         /* -dumpdir */
  OPT_dumpfullversion = 914,                 /* -dumpfullversion */
  OPT_dumpmachine = 915,                     /* -dumpmachine */
  OPT_dumpspecs = 916,                       /* -dumpspecs */
  OPT_dumpversion = 917,                     /* -dumpversion */
  OPT_e = 918,                               /* -e */
  OPT_export_dynamic = 919,                  /* -export-dynamic */
  OPT_fPIC = 920,                            /* -fPIC */
  OPT_fPIE = 921,                            /* -fPIE */
  OPT_fRTS_ = 922,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 923,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 924,                   /* -fabi-version= */
  OPT_faccess_control = 925,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 926,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 927,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 928,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 929,                  /* -falign-commons */
  OPT_falign_functions = 930,                /* -falign-functions */
  OPT_falign_functions_ = 931,               /* -falign-functions= */
  OPT_falign_jumps = 932,                    /* -falign-jumps */
  OPT_falign_jumps_ = 933,                   /* -falign-jumps= */
  OPT_falign_labels = 934,                   /* -falign-labels */
  OPT_falign_labels_ = 935,                  /* -falign-labels= */
  OPT_falign_loops = 936,                    /* -falign-loops */
  OPT_falign_loops_ = 937,                   /* -falign-loops= */
  /* OPT_faligned_new = 938, */              /* -faligned-new */
  OPT_faligned_new_ = 939,                   /* -faligned-new= */
  OPT_fall_instantiations = 940,             /* -fall-instantiations */
  OPT_fall_intrinsics = 941,                 /* -fall-intrinsics */
  OPT_fall_virtual = 942,                    /* -fall-virtual */
  OPT_fallocation_dce = 943,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 944,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 945,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 946,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 947, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 948,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 949,         /* -falt-external-templates */
  OPT_fanalyzer = 950,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 951,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 952,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 953,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 954,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 955,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 956,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 957,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 958,    /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 959,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 960,         /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 961,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 962, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 963,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 964, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 965, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 966, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 967, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 968,            /* -fasan-shadow-offset= */
  OPT_fasm = 969,                            /* -fasm */
  OPT_fassert = 970,                         /* -fassert */
  OPT_fassociative_math = 971,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 972,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 973,                   /* -fauto-inc-dec */
  OPT_fauto_init = 974,                      /* -fauto-init */
  OPT_fauto_profile = 975,                   /* -fauto-profile */
  OPT_fauto_profile_ = 976,                  /* -fauto-profile= */
  OPT_fautomatic = 977,                      /* -fautomatic */
  OPT_fbackslash = 978,                      /* -fbackslash */
  OPT_fbacktrace = 979,                      /* -fbacktrace */
  OPT_fbit_tests = 980,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 981,             /* -fblas-matmul-limit= */
  OPT_fbounds = 982,                         /* -fbounds */
  OPT_fbounds_check = 983,                   /* -fbounds-check */
  OPT_fbounds_check_ = 984,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 985,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 986,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 987, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 988, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 989, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 990,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 991,           /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 992,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 993,                        /* -fbuiltin */
  OPT_fbuiltin_ = 994,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 995,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 996,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 997,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 998,                    /* -fcall-saved- */
  OPT_fcall_used_ = 999,                     /* -fcall-used- */
  OPT_fcaller_saves = 1000,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1001,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1002,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1003,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1004,      /* -fcanonical-system-headers */
  OPT_fcase = 1005,                          /* -fcase */
  /* OPT_fcf_protection = 1006, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1007,                /* -fcf-protection= */
  OPT_fchar8_t = 1008,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1009,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1010, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1011,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1012,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1013,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1014, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1015, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1016, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1017, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1018, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1019, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1020,                  /* -fcheckaction= */
  OPT_fchecking = 1021,                      /* -fchecking */
  OPT_fchecking_ = 1022,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1023,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1024,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1025,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1026,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1027,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1028,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1029,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1030,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1031,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1032,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1033,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1034,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1035,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1036,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1037,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1038,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1039,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1040,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1041, */                /* -fcilkplus */
  OPT_fcoarray_ = 1042,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1043,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1044,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1045,                        /* -fcommon */
  OPT_fcompare_debug = 1046,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1047,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1048,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1049,                  /* -fcompare-elim */
  OPT_fconcepts = 1050,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1051,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1052,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1053,                 /* -fcond-mismatch */
  /* OPT_fconserve_space = 1054, */          /* -fconserve-space */
  OPT_fconserve_stack = 1055,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1056,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1057,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1058,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1059,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1060,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1061,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1062,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1063,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1064,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1065,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1066,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1067,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1068, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1069,                     /* -fcontracts */
  OPT_fconvert_ = 1070,                      /* -fconvert= */
  OPT_fcoroutines = 1071,                    /* -fcoroutines */
  OPT_fcpp = 1072,                           /* -fcpp */
  OPT_fcpp_begin = 1073,                     /* -fcpp-begin */
  OPT_fcpp_end = 1074,                       /* -fcpp-end */
  OPT_fcprop_registers = 1075,               /* -fcprop-registers */
  OPT_fcray_pointer = 1076,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1077,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1078,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1079, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1080,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1081,              /* -fcx-limited-range */
  OPT_fd = 1082,                             /* -fd */
  OPT_fd_lines_as_code = 1083,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1084,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1085,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1086,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1087,                      /* -fdbg-cnt= */
  OPT_fdce = 1088,                           /* -fdce */
  OPT_fdebug = 1089,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1090,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1091,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1092,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1093,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1094,             /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 1095,               /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 1096,              /* -fdebug-trace-quad */
  OPT_fdebug_types_section = 1097,           /* -fdebug-types-section */
  OPT_fdebug_ = 1098,                        /* -fdebug= */
  OPT_fdec = 1099,                           /* -fdec */
  OPT_fdec_blank_format_item = 1100,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1101,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1102,           /* -fdec-format-defaults */
  OPT_fdec_include = 1103,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1104,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1105,                      /* -fdec-math */
  OPT_fdec_static = 1106,                    /* -fdec-static */
  OPT_fdec_structure = 1107,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1108,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1109, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1110,                          /* -fdef= */
  OPT_fdefault_double_8 = 1111,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1112, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1113,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1114,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1115,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1116,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1117,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1118,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1119,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1120,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1121,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1122,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1123,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1124, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1125,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1126,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1127,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1128,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1129,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1130,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1131,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1132,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1133,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1134,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1135,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1136,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1137,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1138, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1139,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1140,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1141,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1142,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1143,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1144,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1145,               /* -fdirectives-only */
  OPT_fdisable_ = 1146,                      /* -fdisable- */
  OPT_fdoc = 1147,                           /* -fdoc */
  OPT_fdoc_dir_ = 1148,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1149,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1150,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1151,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1152,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1153,                      /* -fdruntime */
  OPT_fdse = 1154,                           /* -fdse */
  OPT_fdump_ = 1155,                         /* -fdump- */
  OPT_fdump_ada_spec = 1156,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1157,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1158,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1159,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1160,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1161,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1162,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1163,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1164,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1165,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1166,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1167,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1168,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1169,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1170,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1171,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1172,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1173, */               /* -fdump-core */
  OPT_fdump_d_original = 1174,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1175,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1176,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1177,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1178,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1179,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1180,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1181,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1182,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1183, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1184,                   /* -fdump-passes */
  OPT_fdump_scos = 1185,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1186,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1187,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1188,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1189,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1190,                /* -fearly-inlining */
  OPT_felide_constructors = 1191,            /* -felide-constructors */
  OPT_felide_type = 1192,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1193, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1194,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1195,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1196,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1197,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1198,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1199,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1200,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1201,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1202,                /* -fenum-int-equiv */
  OPT_fexceptions = 1203,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1204,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1205,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1206,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1207,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1208,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1209,               /* -fextended-opaque */
  OPT_fextern_std_ = 1210,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1211,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1212,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1213,            /* -fexternal-templates */
  OPT_ff2c = 1214,                           /* -ff2c */
  OPT_ffast_math = 1215,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1216,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1217,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1218,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1219,              /* -ffinite-math-only */
  OPT_ffixed_ = 1220,                        /* -ffixed- */
  OPT_ffixed_form = 1221,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1222,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1223,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1224,                   /* -ffloat-store */
  OPT_ffloatvalue = 1225,                    /* -ffloatvalue */
  OPT_ffold_simple_inlines = 1226,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1227,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1228, */              /* -fforce-addr */
  OPT_fforward_propagate = 1229,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1230,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1231,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1232,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1233,                     /* -ffpe-trap= */
  OPT_ffree_form = 1234,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1235,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1236,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1237,                  /* -ffreestanding */
  OPT_ffriend_injection = 1238,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1239,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1240,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1241,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1242,             /* -ffunction-sections */
  OPT_fgcse = 1243,                          /* -fgcse */
  OPT_fgcse_after_reload = 1244,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1245,                      /* -fgcse-las */
  OPT_fgcse_lm = 1246,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1247,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1248,              /* -fgen-module-list= */
  OPT_fgimple = 1249,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1250,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1251,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1252,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1253,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1254,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1255,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1256,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1257,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1258,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1259,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1260,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1261,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1262,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1263,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1264,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1265,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1266,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1267,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1268,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1269,                      /* -fgraphite */
  OPT_fgraphite_identity = 1270,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1271,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1272,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1273, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1274,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1275,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1276, */                    /* -fhelp */
  /* OPT_fhelp_ = 1277, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1278,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1279,                     /* -fhonor-std */
  OPT_fhosted = 1280,                        /* -fhosted */
  OPT_fhuge_objects = 1281,                  /* -fhuge-objects */
  OPT_fident = 1282,                         /* -fident */
  OPT_fif_conversion = 1283,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1284,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1285,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1286,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1287,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1288,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1289,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1290,            /* -fimplicit-templates */
  OPT_findex = 1291,                         /* -findex */
  OPT_findirect_inlining = 1292,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1293,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1294,               /* -finit-character= */
  OPT_finit_derived = 1295,                  /* -finit-derived */
  OPT_finit_integer_ = 1296,                 /* -finit-integer= */
  OPT_finit_local_zero = 1297,               /* -finit-local-zero */
  OPT_finit_logical_ = 1298,                 /* -finit-logical= */
  OPT_finit_real_ = 1299,                    /* -finit-real= */
  OPT_finline = 1300,                        /* -finline */
  OPT_finline_arg_packing = 1301,            /* -finline-arg-packing */
  OPT_finline_atomics = 1302,                /* -finline-atomics */
  OPT_finline_functions = 1303,              /* -finline-functions */
  OPT_finline_functions_called_once = 1304,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1305, */           /* -finline-limit- */
  OPT_finline_limit_ = 1306,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1307,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1308,        /* -finline-small-functions */
  OPT_finput_charset_ = 1309,                /* -finput-charset= */
  OPT_finstrument_functions = 1310,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1311,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1312,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1313,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1314,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1315,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1316,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1317,                    /* -finvariants */
  OPT_fipa_bit_cp = 1318,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1319,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1320, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1321,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1322,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1323,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1324,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1325, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1326,                    /* -fipa-modref */
  OPT_fipa_profile = 1327,                   /* -fipa-profile */
  OPT_fipa_pta = 1328,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1329,                /* -fipa-pure-const */
  OPT_fipa_ra = 1330,                        /* -fipa-ra */
  OPT_fipa_reference = 1331,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1332,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1333,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1334,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1335,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1336, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1337,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1338,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1339,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1340,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1341,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1342,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1343,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1344,                  /* -fira-verbose= */
  OPT_fiso = 1345,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1346,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1347,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1348,              /* -fivar-visibility= */
  OPT_fivopts = 1349,                        /* -fivopts */
  OPT_fjump_tables = 1350,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1351,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1352,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1353,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1354,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1355,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1356,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1357,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1358,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1359,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1360,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1361,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1362,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1363,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1364,            /* -fleading-underscore */
  OPT_flibs_ = 1365,                         /* -flibs= */
  OPT_flifetime_dse = 1366,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1367,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1368,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1369,                /* -flinker-output= */
  /* OPT_flive_patching = 1370, */           /* -flive-patching */
  OPT_flive_patching_ = 1371,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1372,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1373,                   /* -flocal-ivars */
  OPT_flocation_ = 1374,                     /* -flocation= */
  /* OPT_floop_block = 1375, */              /* -floop-block */
  /* OPT_floop_flatten = 1376, */            /* -floop-flatten */
  OPT_floop_interchange = 1377,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1378,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1379, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1380,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1381, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1382,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1383,                     /* -flra-remat */
  OPT_flto = 1384,                           /* -flto */
  OPT_flto_compression_level_ = 1385,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1386, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1387,                /* -flto-partition= */
  OPT_flto_report = 1388,                    /* -flto-report */
  OPT_flto_report_wpa = 1389,                /* -flto-report-wpa */
  OPT_flto_ = 1390,                          /* -flto= */
  OPT_fltrans = 1391,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1392,           /* -fltrans-output-list= */
  OPT_fm2_g = 1393,                          /* -fm2-g */
  OPT_fm2_lower_case = 1394,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1395,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1396,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1397,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1398,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1399,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1400,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1401,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1402,             /* -fmacro-prefix-map= */
  OPT_fmain = 1403,                          /* -fmain */
  OPT_fmath_errno = 1404,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1405,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1406,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1407,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1408,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1409,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1410,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1411,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1412,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1413,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1414,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1415,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1416,               /* -fmessage-length= */
  OPT_fmod_ = 1417,                          /* -fmod= */
  OPT_fmodule_file_ = 1418,                  /* -fmodule-file= */
  OPT_fmodule_header = 1419,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1420,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1421,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1422,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1423,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1424,                   /* -fmodule-only */
  OPT_fmodule_private = 1425,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1426,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1427,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1428,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1429,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1430,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1431,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1432,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1433,                 /* -fms-extensions */
  OPT_fmudflap = 1434,                       /* -fmudflap */
  OPT_fmudflapir = 1435,                     /* -fmudflapir */
  OPT_fmudflapth = 1436,                     /* -fmudflapth */
  OPT_fmultiflags = 1437,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1438,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1439,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1440,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1441,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1442,                  /* -fnext-runtime */
  OPT_fnil = 1443,                           /* -fnil */
  OPT_fnil_receivers = 1444,                 /* -fnil-receivers */
  OPT_fno_modules = 1445,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1446,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1447,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1448,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1449,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1450,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1451,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1452,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1453,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1454,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1455,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1456,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1457,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1458,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1459,              /* -foffload-options= */
  OPT_foffload_ = 1460,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1461,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1462,                         /* -fonly= */
  OPT_fopenacc = 1463,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1464,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1465,                        /* -fopenmp */
  OPT_fopenmp_simd = 1466,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1467, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1468,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1469,                /* -foperator-names */
  OPT_fopt_info = 1470,                      /* -fopt-info */
  OPT_fopt_info_ = 1471,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1472, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1473,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1474,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1475, */          /* -foptional-diags */
  OPT_fpack_derived = 1476,                  /* -fpack-derived */
  OPT_fpack_struct = 1477,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1478,                  /* -fpack-struct= */
  OPT_fpad_source = 1479,                    /* -fpad-source */
  OPT_fpartial_inlining = 1480,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1481,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1482,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1483,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1484,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1485,                    /* -fpeel-loops */
  OPT_fpeephole = 1486,                      /* -fpeephole */
  OPT_fpeephole2 = 1487,                     /* -fpeephole2 */
  OPT_fpermissive = 1488,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1489,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1490,                           /* -fpic */
  OPT_fpie = 1491,                           /* -fpie */
  OPT_fpim = 1492,                           /* -fpim */
  OPT_fpim2 = 1493,                          /* -fpim2 */
  OPT_fpim3 = 1494,                          /* -fpim3 */
  OPT_fpim4 = 1495,                          /* -fpim4 */
  OPT_fplan9_extensions = 1496,              /* -fplan9-extensions */
  OPT_fplt = 1497,                           /* -fplt */
  OPT_fplugin_arg_ = 1498,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1499,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1500,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1501,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1502,                /* -fpostconditions */
  OPT_fpre_include_ = 1503,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1504,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1505,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1506,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1507,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1508,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1509,              /* -fpretty-templates */
  OPT_fpreview_all = 1510,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1511,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1512,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1513,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1514,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1515,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1516,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1517,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1518,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1519,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1520,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1521,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1522,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1523,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1524,           /* -fprintf-return-value */
  OPT_fprofile = 1525,                       /* -fprofile */
  OPT_fprofile_abs_path = 1526,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1527,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1528,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1529,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1530,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1531,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1532,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1533,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1534,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1535,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1536,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1537,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1538,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1539,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1540,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1541,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1542,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1543,               /* -fprofile-update= */
  OPT_fprofile_use = 1544,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1545,                  /* -fprofile-use= */
  OPT_fprofile_values = 1546,                /* -fprofile-values */
  OPT_fprotect_parens = 1547,                /* -fprotect-parens */
  OPT_fpthread = 1548,                       /* -fpthread */
  OPT_fq = 1549,                             /* -fq */
  OPT_frandom_seed = 1550,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1551,                  /* -frandom-seed= */
  OPT_frange = 1552,                         /* -frange */
  OPT_frange_check = 1553,                   /* -frange-check */
  OPT_freal_4_real_10 = 1554,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1555,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1556,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1557,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1558,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1559,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1560,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1561,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1562,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1563,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1564,               /* -frecord-marker=8 */
  OPT_frecursive = 1565,                     /* -frecursive */
  OPT_free = 1566,                           /* -free */
  OPT_freg_struct_return = 1567,             /* -freg-struct-return */
  /* OPT_fregmove = 1568, */                 /* -fregmove */
  OPT_frelease = 1569,                       /* -frelease */
  OPT_frename_registers = 1570,              /* -frename-registers */
  OPT_freorder_blocks = 1571,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1572,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1573,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1574,             /* -freorder-functions */
  OPT_frepack_arrays = 1575,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1576,          /* -freplace-objc-classes */
  OPT_frepo = 1577,                          /* -frepo */
  OPT_freport_bug = 1578,                    /* -freport-bug */
  OPT_frequire_return_statement = 1579,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1580,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1581, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1582,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1583,                   /* -fresolution= */
  OPT_freturn = 1584,                        /* -freturn */
  OPT_frevert_all = 1585,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1586,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1587,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1588,             /* -frevert=intpromote */
  OPT_frounding_math = 1589,                 /* -frounding-math */
  OPT_frtti = 1590,                          /* -frtti */
  OPT_fruntime_modules_ = 1591,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1592,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1593,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1594,                   /* -frust-crate= */
  OPT_frust_debug = 1595,                    /* -frust-debug */
  OPT_frust_dump_ = 1596,                    /* -frust-dump- */
  OPT_frust_edition_ = 1597,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1598,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1599,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1600,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1601,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1602,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1603,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1604,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1605,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1606,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1607,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1608,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1609,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1610, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1611,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1612,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1613,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1614,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1615,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1616,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1617,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1618,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1619, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1620,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1621,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1622,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1623,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1624,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1625,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1626,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1627,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1628,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1629,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1630,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1631,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1632,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1633,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1634,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1635,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1636, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1637,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1638,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1639,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1640,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1641,               /* -fsection-anchors */
  /* OPT_fsee = 1642, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1643,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1644,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1645,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1646,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1647,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1648,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1649,        /* -fsemantic-interposition */
  OPT_fshared = 1650,                        /* -fshared */
  OPT_fshort_enums = 1651,                   /* -fshort-enums */
  OPT_fshort_wchar = 1652,                   /* -fshort-wchar */
  OPT_fshow_column = 1653,                   /* -fshow-column */
  OPT_fshrink_wrap = 1654,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1655,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1656,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1657,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1658,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1659,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1660,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1661,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1662,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1663,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1664,                /* -fsoft-check-all */
  OPT_fsources = 1665,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1666,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1667,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1668,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1669,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1670,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1671,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1672,                      /* -fsquangle */
  OPT_fssa_backprop = 1673,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1674,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1675,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1676,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1677, */             /* -fstack-check */
  OPT_fstack_check_ = 1678,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1679,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1680,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1681,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1682,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1683,               /* -fstack-protector */
  OPT_fstack_protector_all = 1684,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1685,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1686,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1687,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1688,                   /* -fstack-usage */
  OPT_fstats = 1689,                         /* -fstats */
  OPT_fstdarg_opt = 1690,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1691,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1692, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1693,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1694,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1695, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1696,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1697,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1698,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1699,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1700, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1701,            /* -fstrong-eval-order= */
  OPT_fswig = 1702,                          /* -fswig */
  OPT_fswitch_errors = 1703,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1704,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1705,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1706,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1707, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1708,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1709, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1710,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1711, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1712,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1713,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1714,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1715,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1716,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1717,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1718,                   /* -ftime-report */
  OPT_ftime_report_details = 1719,           /* -ftime-report-details */
  OPT_ftls_model_ = 1720,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1721,              /* -ftoplevel-reorder */
  OPT_ftracer = 1722,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1723,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1724,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1725,                   /* -ftrampolines */
  OPT_ftransition_all = 1726,                /* -ftransition=all */
  OPT_ftransition_field = 1727,              /* -ftransition=field */
  OPT_ftransition_in = 1728,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1729,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1730,          /* -ftransition=templates */
  OPT_ftransition_tls = 1731,                /* -ftransition=tls */
  OPT_ftrapping_math = 1732,                 /* -ftrapping-math */
  OPT_ftrapv = 1733,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1734,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1735,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1736,                      /* -ftree-ccp */
  OPT_ftree_ch = 1737,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1738, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1739,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1740,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1741, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1742,                   /* -ftree-cselim */
  OPT_ftree_dce = 1743,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1744,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1745,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1746,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1747,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1748, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1749,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1750,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1751, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1752,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1753,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1754, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1755,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1756,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1757,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1758,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1759,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1760,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1761,                      /* -ftree-pre */
  OPT_ftree_pta = 1762,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1763,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1764, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1765,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1766,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1767,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1768,                     /* -ftree-slsr */
  OPT_ftree_sra = 1769,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1770, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1771, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1772,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1773,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1774,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1775, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1776,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1777, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1778,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1779,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1780,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1781,         /* -funconstrained-commons */
  OPT_funderscoring = 1782,                  /* -funderscoring */
  OPT_funit_at_a_time = 1783,                /* -funit-at-a-time */
  OPT_funittest = 1784,                      /* -funittest */
  OPT_funreachable_traps = 1785,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1786,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1787,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1788,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1789, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1790,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1791,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1792,                 /* -funsigned-char */
  OPT_funswitch_loops = 1793,                /* -funswitch-loops */
  OPT_funwind_tables = 1794,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1795,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1796,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1797,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1798,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1799,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1800,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1801,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1802,                     /* -fuse-list= */
  OPT_fvar_tracking = 1803,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1804,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1805,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1806,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1807,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1808, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1809,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1810,                   /* -fverbose-asm */
  /* OPT_fversion = 1811, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1812,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1813,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1814,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1815,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1816,                   /* -fvisibility= */
  OPT_fvpt = 1817,                           /* -fvpt */
  OPT_fvtable_gc = 1818,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1819,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1820,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1821,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1822,                     /* -fvtv-debug */
  OPT_fweak = 1823,                          /* -fweak */
  OPT_fweak_templates = 1824,                /* -fweak-templates */
  OPT_fweb = 1825,                           /* -fweb */
  /* OPT_fwhole_file = 1826, */              /* -fwhole-file */
  OPT_fwhole_program = 1827,                 /* -fwhole-program */
  OPT_fwholediv = 1828,                      /* -fwholediv */
  OPT_fwholevalue = 1829,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1830,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1831,             /* -fworking-directory */
  OPT_fwpa = 1832,                           /* -fwpa */
  OPT_fwpa_ = 1833,                          /* -fwpa= */
  OPT_fwrapv = 1834,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1835,                 /* -fwrapv-pointer */
  OPT_fxref = 1836,                          /* -fxref */
  /* OPT_fzee = 1837, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1838,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1839,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1840,                     /* -fzero-link */
  OPT_g = 1841,                              /* -g */
  OPT_gant = 1842,                           /* -gant */
  OPT_gas_loc_support = 1843,                /* -gas-loc-support */
  OPT_gas_locview_support = 1844,            /* -gas-locview-support */
  OPT_gbtf = 1845,                           /* -gbtf */
  OPT_gcoff = 1846,                          /* -gcoff */
  OPT_gcoff1 = 1847,                         /* -gcoff1 */
  OPT_gcoff2 = 1848,                         /* -gcoff2 */
  OPT_gcoff3 = 1849,                         /* -gcoff3 */
  OPT_gcolumn_info = 1850,                   /* -gcolumn-info */
  OPT_gctf = 1851,                           /* -gctf */
  OPT_gdescribe_dies = 1852,                 /* -gdescribe-dies */
  OPT_gdwarf = 1853,                         /* -gdwarf */
  OPT_gdwarf_ = 1854,                        /* -gdwarf- */
  OPT_gdwarf32 = 1855,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1856,                       /* -gdwarf64 */
  OPT_gen_decls = 1857,                      /* -gen-decls */
  OPT_ggdb = 1858,                           /* -ggdb */
  OPT_ggnu_pubnames = 1859,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1860,                   /* -gimple-stats */
  OPT_ginline_points = 1861,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1862, /* -ginternal-reset-location-views */
  OPT_gnat = 1863,                           /* -gnat */
  OPT_gnatO = 1864,                          /* -gnatO */
  OPT_gno_ = 1865,                           /* -gno- */
  OPT_gno_pubnames = 1866,                   /* -gno-pubnames */
  OPT_gpubnames = 1867,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1868,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1869,                   /* -gsplit-dwarf */
  OPT_gstabs = 1870,                         /* -gstabs */
  OPT_gstabs_ = 1871,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1872,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1873,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1874,                        /* -gtoggle */
  OPT_gvariable_location_views = 1875,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1876,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1877,                           /* -gvms */
  OPT_gxcoff = 1878,                         /* -gxcoff */
  OPT_gxcoff_ = 1879,                        /* -gxcoff+ */
  OPT_gz = 1880,                             /* -gz */
  OPT_gz_ = 1881,                            /* -gz= */
  OPT_h = 1882,                              /* -h */
  OPT_help = 1883,                           /* -help */
  OPT_idirafter = 1884,                      /* -idirafter */
  OPT_imacros = 1885,                        /* -imacros */
  OPT_imultiarch = 1886,                     /* -imultiarch */
  OPT_imultilib = 1887,                      /* -imultilib */
  OPT_include = 1888,                        /* -include */
  OPT_iplugindir_ = 1889,                    /* -iplugindir= */
  OPT_iprefix = 1890,                        /* -iprefix */
  OPT_iquote = 1891,                         /* -iquote */
  OPT_isysroot = 1892,                       /* -isysroot */
  OPT_isystem = 1893,                        /* -isystem */
  OPT_iwithprefix = 1894,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1895,              /* -iwithprefixbefore */
  OPT_k8 = 1896,                             /* -k8 */
  OPT_l = 1897,                              /* -l */
  OPT_lang_asm = 1898,                       /* -lang-asm */
  OPT_list = 1899,                           /* -list */
  OPT_mabi_ = 1900,                          /* -mabi= */
  OPT_march_ = 1901,                         /* -march= */
  OPT_mbig_endian = 1902,                    /* -mbig-endian */
  OPT_mbionic = 1903,                        /* -mbionic */
  OPT_mbranch_protection_ = 1904,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1905,                       /* -mcmodel= */
  OPT_mcpu_ = 1906,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1907,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1908,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1909,             /* -mgeneral-regs-only */
  OPT_mglibc = 1910,                         /* -mglibc */
  OPT_mharden_sls_ = 1911,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1912,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1913,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1914,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1915,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1916,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1917,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1918,               /* -moutline-atomics */
  OPT_moverride_ = 1919,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1920,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1921,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1922, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1923,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1924,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1925,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1926,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1927,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1928,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1929,             /* -mtrack-speculation */
  OPT_mtune_ = 1930,                         /* -mtune= */
  OPT_muclibc = 1931,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1932,             /* -mverbose-cost-dump */
  OPT_n = 1933,                              /* -n */
  OPT_name_sort = 1934,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1935,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1936,              /* -no-integrated-cpp */
  OPT_no_pie = 1937,                         /* -no-pie */
  OPT_nocpp = 1938,                          /* -nocpp */
  OPT_nodefaultlibs = 1939,                  /* -nodefaultlibs */
  OPT_nolibc = 1940,                         /* -nolibc */
  OPT_nophoboslib = 1941,                    /* -nophoboslib */
  OPT_nostartfiles = 1942,                   /* -nostartfiles */
  OPT_nostdinc = 1943,                       /* -nostdinc */
  OPT_nostdinc__ = 1944,                     /* -nostdinc++ */
  OPT_nostdlib = 1945,                       /* -nostdlib */
  OPT_nostdlib__ = 1946,                     /* -nostdlib++ */
  OPT_o = 1947,                              /* -o */
  OPT_objects = 1948,                        /* -objects */
  OPT_p = 1949,                              /* -p */
  OPT_pass_exit_codes = 1950,                /* -pass-exit-codes */
  /* OPT_pedantic = 1951, */                 /* -pedantic */
  OPT_pedantic_errors = 1952,                /* -pedantic-errors */
  OPT_pg = 1953,                             /* -pg */
  OPT_pie = 1954,                            /* -pie */
  OPT_pipe = 1955,                           /* -pipe */
  OPT_posix = 1956,                          /* -posix */
  ...
  OPT_profile = 1969,                        /* -profile */
  OPT_pthread = 1970,                        /* -pthread */
  OPT_quiet = 1971,                          /* -quiet */
  OPT_r = 1972,                              /* -r */
  OPT_rdynamic = 1973,                       /* -rdynamic */
  OPT_remap = 1974,                          /* -remap */
  OPT_reverse_sort = 1975,                   /* -reverse-sort */
  OPT_s = 1976,                              /* -s */
  OPT_save_temps = 1977,                     /* -save-temps */
  OPT_save_temps_ = 1978,                    /* -save-temps= */
  OPT_shared = 1979,                         /* -shared */
  OPT_shared_libgcc = 1980,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1981,               /* -shared-libphobos */
  OPT_size_sort = 1982,                      /* -size-sort */
  /* OPT_specs = 1983, */                    /* -specs */
  OPT_specs_ = 1984,                         /* -specs= */
  OPT_static = 1985,                         /* -static */
  OPT_static_libasan = 1986,                 /* -static-libasan */
  OPT_static_libgcc = 1987,                  /* -static-libgcc */
  OPT_static_libgfortran = 1988,             /* -static-libgfortran */
  OPT_static_libgm2 = 1989,                  /* -static-libgm2 */
  OPT_static_libgo = 1990,                   /* -static-libgo */
  OPT_static_libhwasan = 1991,               /* -static-libhwasan */
  OPT_static_liblsan = 1992,                 /* -static-liblsan */
  OPT_static_libmpx = 1993,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1994,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1995,               /* -static-libphobos */
  OPT_static_libquadmath = 1996,             /* -static-libquadmath */
  OPT_static_libstdc__ = 1997,               /* -static-libstdc++ */
  OPT_static_libtsan = 1998,                 /* -static-libtsan */
  OPT_static_libubsan = 1999,                /* -static-libubsan */
  OPT_static_pie = 2000,                     /* -static-pie */
  /* OPT_std_c__03 = 2001, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2002, */                /* -std=c++0x */
  OPT_std_c__11 = 2003,                      /* -std=c++11 */
  OPT_std_c__14 = 2004,                      /* -std=c++14 */
  OPT_std_c__17 = 2005,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2006, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2007, */                /* -std=c++1z */
  OPT_std_c__20 = 2008,                      /* -std=c++20 */
  OPT_std_c__23 = 2009,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2010, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2011, */                /* -std=c++2b */
  OPT_std_c__98 = 2012,                      /* -std=c++98 */
  OPT_std_c11 = 2013,                        /* -std=c11 */
  OPT_std_c17 = 2014,                        /* -std=c17 */
  /* OPT_std_c18 = 2015, */                  /* -std=c18 */
  /* OPT_std_c1x = 2016, */                  /* -std=c1x */
  OPT_std_c2x = 2017,                        /* -std=c2x */
  /* OPT_std_c89 = 2018, */                  /* -std=c89 */
  OPT_std_c90 = 2019,                        /* -std=c90 */
  OPT_std_c99 = 2020,                        /* -std=c99 */
  /* OPT_std_c9x = 2021, */                  /* -std=c9x */
  OPT_std_f2003 = 2022,                      /* -std=f2003 */
  OPT_std_f2008 = 2023,                      /* -std=f2008 */
  OPT_std_f2008ts = 2024,                    /* -std=f2008ts */
  OPT_std_f2018 = 2025,                      /* -std=f2018 */
  OPT_std_f95 = 2026,                        /* -std=f95 */
  OPT_std_gnu = 2027,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2028, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2029, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2030,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2031,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2032,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2033, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2034, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2035,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2036,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2037, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2038, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2039,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2040,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2041,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2042, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2043, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2044,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2045, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2046,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2047,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2048, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2049, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2050,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2051, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2052, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2053, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2054, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2055, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2056,                     /* -std=legacy */
  OPT_stdlib_ = 2057,                        /* -stdlib= */
  OPT_symbol_ = 2058,                        /* -symbol= */
  OPT_symbolic = 2059,                       /* -symbolic */
  OPT_t = 2060,                              /* -t */
  OPT_time = 2061,                           /* -time */
  OPT_time_ = 2062,                          /* -time= */
  OPT_traditional = 2063,                    /* -traditional */
  OPT_traditional_cpp = 2064,                /* -traditional-cpp */
  OPT_tree_stats = 2065,                     /* -tree-stats */
  OPT_trigraphs = 2066,                      /* -trigraphs */
  OPT_type_stats = 2067,                     /* -type-stats */
  OPT_u = 2068,                              /* -u */
  OPT_undef = 2069,                          /* -undef */
  OPT_v = 2070,                              /* -v */
  OPT_version = 2071,                        /* -version */
  OPT_w = 2072,                              /* -w */
  OPT_wrapper = 2073,                        /* -wrapper */
  OPT_x = 2074,                              /* -x */
  OPT_z = 2075,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
