...
typedef enum {
	...
	I_CAL_DISPLAY_PARAMETER = ICAL_DISPLAY_PARAMETER,
	I_CAL_EMAIL_PARAMETER = ICAL_EMAIL_PARAMETER,
	...
	I_CAL_FEATURE_PARAMETER = ICAL_FEATURE_PARAMETER,
	...
	I_CAL_LABEL_PARAMETER = ICAL_LABEL_PARAMETER,
	...
	I_CAL_PATCHACTION_PARAMETER = ICAL_PATCHACTION_PARAMETER,
...
typedef enum {
	I_CAL_DISPLAY_X = ICAL_DISPLAY_X,
	I_CAL_DISPLAY_BADGE = ICAL_DISPLAY_BADGE,
	I_CAL_DISPLAY_GRAPHIC = ICAL_DISPLAY_GRAPHIC,
	I_CAL_DISPLAY_FULLSIZE = ICAL_DISPLAY_FULLSIZE,
	I_CAL_DISPLAY_THUMBNAIL = ICAL_DISPLAY_THUMBNAIL,
	I_CAL_DISPLAY_NONE = ICAL_DISPLAY_NONE
...
typedef enum {
	I_CAL_FEATURE_X = ICAL_FEATURE_X,
	I_CAL_FEATURE_AUDIO = ICAL_FEATURE_AUDIO,
	I_CAL_FEATURE_CHAT = ICAL_FEATURE_CHAT,
	I_CAL_FEATURE_FEED = ICAL_FEATURE_FEED,
	I_CAL_FEATURE_MODERATOR = ICAL_FEATURE_MODERATOR,
	I_CAL_FEATURE_PHONE = ICAL_FEATURE_PHONE,
	I_CAL_FEATURE_SCREEN = ICAL_FEATURE_SCREEN,
	I_CAL_FEATURE_VIDEO = ICAL_FEATURE_VIDEO,
	I_CAL_FEATURE_NONE = ICAL_FEATURE_NONE
...
typedef enum {
	I_CAL_PATCHACTION_X = ICAL_PATCHACTION_X,
	I_CAL_PATCHACTION_CREATE = ICAL_PATCHACTION_CREATE,
	I_CAL_PATCHACTION_BYNAME = ICAL_PATCHACTION_BYNAME,
	I_CAL_PATCHACTION_BYVALUE = ICAL_PATCHACTION_BYVALUE,
	I_CAL_PATCHACTION_BYPARAM = ICAL_PATCHACTION_BYPARAM,
	I_CAL_PATCHACTION_NONE = ICAL_PATCHACTION_NONE
...
LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_display	(ICalParameterDisplay value);
...
LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_display	(ICalParameter *param,
						 ICalParameterDisplay value);

LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_email	(const gchar *value);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_parameter_get_email	(const ICalParameter *param);

LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_email	(ICalParameter *param,
						 const gchar *value);
...
LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_feature	(ICalParameterFeature value);
...
LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_feature	(ICalParameter *param,
...
LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_label	(const gchar *value);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_parameter_get_label	(const ICalParameter *param);

LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_label	(ICalParameter *param,
						 const gchar *value);
...
LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_patchaction	(ICalParameterPatchaction value);
...
LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_patchaction	(ICalParameter *param,
